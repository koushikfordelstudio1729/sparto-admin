...
const CustomButton = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const baseClasses =
      "inline-flex items-center justify-center font-medium transition-all duration-200 rounded-lg font-['Poppins'] font-normal";
    ...
    const variantClasses = {
      primary:
        "bg-indigo-600  hover:bg-indigo-700 active:bg-blue-800 text-white shadow-sm",
      secondary:
